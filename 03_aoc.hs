...
getEpsilonRateBin [] = []
getEpsilonRateBin (x : xs)
  | x == '0' = '1' : getEpsilonRateBin xs
  | otherwise = '0' : getEpsilonRateBin xs

powerCounsumption :: String -> Integer
powerCounsumption xs = readBinToInt grb * readBinToInt erb
  where
